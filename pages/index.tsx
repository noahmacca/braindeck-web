                        ...
                        <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
                            <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                                ...
                                <div className="block md:ml-10 md:pr-4 space-x-8">
                                    ...
                                    {!auth.userId && <a href="#" className="font-medium text-indigo-600 hover:text-indigo-400">Log in</a>}
                                </div>
                            </nav>
                        </div>
                        <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                            <div className="sm:text-center lg:text-left">
                                ...
                                <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                    Ramp up on any topic with curated learning paths from the world's experts.
                                </p>
